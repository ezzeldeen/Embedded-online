...
typedef struct
{
	...
	uint8_t GPIO_MODE ;			//Specifies the Operation mode for the selected pins to be configured.
								// This parameter can be a value of @ref GPIO_MODE_define.

	uint8_t GPIO_Output_Speed ;			//Specifies the Speed for the selected pins to be configured.
