...
typedef struct
{
	...
	uint32_t	BaudRate;		// This member config the baudrate
...
#define UART_Payload_Legth_8B			(uint32_t)(0)
#define UART_Payload_Legth_9B			(uint32_t)(1<<12)
...
#define UART_IRQ_Enable_RXNEIE		(uint32_t)(1<<5)	// Received data ready to be read and overrun
